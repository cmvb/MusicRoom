...
public final class ConstantesValidaciones {
	...
	// Rutas Útiles
	public static final String RUTA_JASPER_REPORTS_USUARIO = "/reports/usuario/";
	public static final String RUTA_JASPER_REPORTS_UBICACION = "/reports/ubicacion/";
	public static final String RUTA_JASPER_REPORTS_TERCERO = "/reports/tercero/";
}
